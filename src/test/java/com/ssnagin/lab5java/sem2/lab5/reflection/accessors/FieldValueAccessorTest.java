...
class FieldValueAccessorTest {
    ...
    void accessValueOnRecord() {
        ...
        assertDoesNotThrow(() -> {
            ValueAccessor<String> accessor = new FieldValueAccessor<>(String.class, RecordWithGetter.class.getDeclaredField("s"));
    ...
    void accessValueOnClass() {
        ...
        assertDoesNotThrow(() -> {
            ValueAccessor<String> accessor = new FieldValueAccessor<>(String.class, ClassWithGetter.class.getDeclaredField("s"));
            String accessedValue = accessor.accessValue(recordWithGetter);
            assertEquals(expectedValue, accessedValue);
        });
    }
