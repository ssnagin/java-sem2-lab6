...
Клиентский модуль должен в интерактивном режиме считывать команды, передавать их для выполнения на сервер и выводить
...
- Клиент должен корректно обрабатывать _временную недоступность сервера._
